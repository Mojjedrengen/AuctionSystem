...
type ExtendedSelf struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RepSelf        *Self                  `protobuf:"bytes,1,opt,name=RepSelf,proto3" json:"RepSelf,omitempty"`
	AuctionAddress string                 `protobuf:"bytes,2,opt,name=AuctionAddress,proto3" json:"AuctionAddress,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *ExtendedSelf) Reset() {
	*x = ExtendedSelf{}
...
func (x *ExtendedSelf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtendedSelf) ProtoMessage() {}

func (x *ExtendedSelf) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_auctionsystem_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtendedSelf.ProtoReflect.Descriptor instead.
func (*ExtendedSelf) Descriptor() ([]byte, []int) {
	return file_grpc_auctionsystem_proto_rawDescGZIP(), []int{5}
}

func (x *ExtendedSelf) GetRepSelf() *Self {
	if x != nil {
		return x.RepSelf
	}
	return nil
...
func (x *ExtendedSelf) GetAuctionAddress() string {
	if x != nil {
...
func (x *AuctionData) Reset() {
	*x = AuctionData{}
	mi := &file_grpc_auctionsystem_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuctionData) Descriptor() ([]byte, []int) {
	return file_grpc_auctionsystem_proto_rawDescGZIP(), []int{7}
}
...
const file_grpc_auctionsystem_proto_rawDesc = "" +
	...
	"_exception\"e\n" +
	"\fExtendedSelf\x12-\n" +
	"\aRepSelf\x18\x01 \x01(\v2\x13.auctionsystem.selfR\aRepSelf\x12&\n" +
	"\x0eAuctionAddress\x18\x02 \x01(\tR\x0eAuctionAddress\"0\n" +
	"\x04self\x12\x18\n" +
	...
	"\x06Result\x12\x16.google.protobuf.Empty\x1a\x18.auctionsystem.resultmsg\"\x002\xcf\x02\n" +
	...
	"\n" +
	"GetCluster\x12\x13.auctionsystem.self\x1a\x1a.auctionsystem.ClusterInfo\x12F\n" +
	"\x10AccensionAttempt\x12\x1b.auctionsystem.ExtendedSelf\x1a\x15.auctionsystem.ackmsgB:Z8github.com/Mojjedrengen/AuctionSystem/grpc/auctionsystemb\x06proto3"
...
var file_grpc_auctionsystem_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_grpc_auctionsystem_proto_goTypes = []any{
	...
	(*ExtendedSelf)(nil),  // 7: auctionsystem.ExtendedSelf
	(*Self)(nil),          // 8: auctionsystem.self
	(*AuctionData)(nil),   // 9: auctionsystem.AuctionData
	nil,                   // 10: auctionsystem.ClusterInfo.MembersEntry
...
var file_grpc_auctionsystem_proto_depIdxs = []int32{
	...
	10, // 3: auctionsystem.ClusterInfo.members:type_name -> auctionsystem.ClusterInfo.MembersEntry
	1,  // 4: auctionsystem.ackmsg.ack:type_name -> auctionsystem.ack
	8,  // 5: auctionsystem.ExtendedSelf.RepSelf:type_name -> auctionsystem.self
	3,  // 6: auctionsystem.AuctionData.highestbidder:type_name -> auctionsystem.UUID
	3,  // 7: auctionsystem.AuctionData.knownBidders:type_name -> auctionsystem.UUID
	3,  // 8: auctionsystem.AuctionData.lastWonBidder:type_name -> auctionsystem.UUID
	0,  // 9: auctionsystem.AuctionData.state:type_name -> auctionsystem.state
	2,  // 10: auctionsystem.Auction.Bid:input_type -> auctionsystem.amount
	11, // 11: auctionsystem.Auction.Result:input_type -> google.protobuf.Empty
	8,  // 12: auctionsystem.ReplicationSync.Fetch:input_type -> auctionsystem.self
	8,  // 13: auctionsystem.ReplicationSync.Heartbeat:input_type -> auctionsystem.self
	8,  // 14: auctionsystem.ReplicationSync.RegisterNode:input_type -> auctionsystem.self
	8,  // 15: auctionsystem.ReplicationSync.GetCluster:input_type -> auctionsystem.self
	7,  // 16: auctionsystem.ReplicationSync.AccensionAttempt:input_type -> auctionsystem.ExtendedSelf
	6,  // 17: auctionsystem.Auction.Bid:output_type -> auctionsystem.ackmsg
	4,  // 18: auctionsystem.Auction.Result:output_type -> auctionsystem.resultmsg
	9,  // 19: auctionsystem.ReplicationSync.Fetch:output_type -> auctionsystem.AuctionData
	11, // 20: auctionsystem.ReplicationSync.Heartbeat:output_type -> google.protobuf.Empty
	11, // 21: auctionsystem.ReplicationSync.RegisterNode:output_type -> google.protobuf.Empty
	5,  // 22: auctionsystem.ReplicationSync.GetCluster:output_type -> auctionsystem.ClusterInfo
	6,  // 23: auctionsystem.ReplicationSync.AccensionAttempt:output_type -> auctionsystem.ackmsg
